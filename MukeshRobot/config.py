...
class Config(object):
    ...
    API_ID = "20923699" # integer value, dont use ""
    API_HASH = "91750e91c717855af7f79e5b71f5cf79"
    TOKEN = ""  # This var used to be API_KEY but it is now TOKEN, adjust accordingly.
    OWNER_ID = "7928692391" # If you dont know, run the bot and do /id in your private chat with it, also an integer
    OWNER_USERNAME = "Rajputvillain"
    SUPPORT_CHAT = "Dpz_V"  # Your own group for support, do not add the @
    JOIN_LOGGER = (
        -1001869233131
    ...
    DONATION_LINK = "https://t.me/Rajputvillain" # EG, paypal
    CERT_PATH = None
    PORT = 5000
